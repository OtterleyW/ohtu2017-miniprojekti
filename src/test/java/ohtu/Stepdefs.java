...
public class Stepdefs {
    ...
    public void user_has_selected_Lisaa_tagi() throws Throwable {
        ...
        WebElement element = driver.findElement(By.partialLinkText("Topologia I"));
        element.click();
        Thread.sleep(1000);
        element = driver.findElement(By.partialLinkText("Lisää tagi"));
        element.click();
        Thread.sleep(1000);
    ...
    @Then("^Topologia I has new tag \"([^\"]*)\"$")
    public void topologia_I_has_new_tag(String tag) throws Throwable {
        pageHasContent(tag);
    }
